...
tataḥ praṇidhim anusmṛtya, samādher vyutthāya, repheṇa purataḥ sūryamaṇḍalaṃ dhyātvā, \vedtext{tatra}{
	...
	Simply correcting the manuscript's reading from \emph{aṇusaṃhater vvajraiḥ} to \emph{aṇusaṃhatair vajraiḥ} does not yield adaquate sense here in my opinion.
	The Tibetan translation reads \emph{'od zer gyi rdul phra rab kyi tshogs 'phros pa des}, and on this basis we may conjecture a reading along the lines of \emph{sphuradbhir aṇusaṃhatair raśmibhiḥ} (`with like light densely packed with particles'). 
	...
	\begin{quote}
		purastād agnivarṇena repheṇa sūryamaṇḍalaṃ dhyātvā tanmadhye hūṃkāreṇa viśvavajraṃ vicintya tatkiraṇasūkṣmavajraiḥ sphuradbhiś caturdiggatair atyantaṃ ghanībhāvāt prākāraṃ bhāvayet (as cited in \cite[293]{isaacson2007}).
	\end{quote}
	
	Here we see that it is indeed more vajra from the initial vajra that product the fence, and these are described as `[made of] the light rays of that [initial vajra]'.
...
tadanantaraṃ khadhātau dharmodayākārām antaḥsuṣirām atibahaladhavalām ūrdhvāṃ\footnote{\begin{english}
	Where the manuscript reads \emph{ūrdhvāṃ}, \TIB\ reads \emph{steng yang pa}, perhaps reflecting \emph{upari viśālām}.
	This latter reading has the advantage of many parallels in other descriptions of the \emph{dharmodaya}, such as the one found in Advayavajra's \emph{Hevajraviśuddhisādhana} (f. 67v): \emph{adhaḥ sūkṣaṃ upari viśālaṃ trikoṇam}.
...
atra\footnote{
	...
	Perhaps \emph{tatra} with a partative sense would read better here, but I don't see very strong reasons to discount \emph{atra}.
...
latājaṭyāṃ\footnote{\begin{english}
	Other sources name the this tree as \emph{parkaṭī}.
	Amara gives \emph{jaṭī} as a synonym.
\end{english}} naravāhano manuṣyamukhaḥ pāṇḍur nairṛtyām.
...
sarve cāmī vāmakarakalitakapālā nānāstravyagradakṣiṇapāṇayo darśitapūrvārdhakāyāḥ.\footnote{\begin{english}
	\hl{QUESTION} : Is Advayavajra equating the \emph{dikpāla}s and \emph{mahardhika}s? In what sense are the `in' trees?
\end{english}}
\pend
...
meghāś cāṣṭau mecaka\dsh śukla\dsh śiti\dsh pāṇḍu\dsh rakta\dsh pīta\dsh harita\dsh viśvavarṇāś cintanīyāḥ.\footnote{\begin{english}
